...
class FakePipelines:
    ...
    def __init__(self):
        self.columns = {
            PLAN: [FakeCol(PLAN, "idea", "Idea"), FakeCol(PLAN, "plan", "Plan")],
            MAINT: [FakeCol(MAINT, "report", "Report"), FakeCol(MAINT, "plan", "Plan")],
            BUILD: [FakeCol(BUILD, "build", "Build"), FakeCol(BUILD, "ship", "Ship")],
        }

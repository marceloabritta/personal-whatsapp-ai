// ============================================================================
//  legacy/router.js  —  FROZEN. Verbatim copy of router/router.js as it was at HEAD
//  (commit before card 55e00052). Exported as route() and imported ONLY by the legacy
//  (@assistant / OLD) path in server.js. It returns the OLD { tasks, lang, info } shape and
//  imports the frozen legacy/prompt.js + legacy/inputs.js — nothing from the NEW flow. This
//  is the guarantee that a bug in the @mary router cannot reach @assistant. Do NOT edit.
// ============================================================================
